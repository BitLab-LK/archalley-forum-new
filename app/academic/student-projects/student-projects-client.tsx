...
export default function StudentProjectsClient({ 
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Student Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our student projects showcase. Please check back soon for our latest student work." },
      content: { rendered: "Our student projects, coursework, and academic portfolios will be available soon with detailed project descriptions and galleries." },
      featured_media: 1,
      ...
      _embedded: {
        'wp:featuredmedia': [{
          ...
          alt_text: "Student Projects Coming Soon",
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getStudentProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Student Projects", slug: "student-projects", description: "Student projects and coursework", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover creative and innovative work from our architecture and design students. 
            Browse through coursework, thesis projects, and academic portfolios showcasing emerging talent.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Student projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-student-projects"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
