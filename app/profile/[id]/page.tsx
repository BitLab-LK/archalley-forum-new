                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                    ...
                    {user.instagramUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-pink-50 to-purple-100 dark:from-pink-950 dark:to-purple-900 hover:from-pink-100 hover:to-purple-200 dark:hover:from-pink-900 dark:hover:to-purple-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-pink-200 dark:border-pink-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">�</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-pink-800 dark:text-pink-200 font-semibold text-sm block truncate">Instagram</span>
                          <span className="text-pink-600 dark:text-pink-400 text-xs opacity-75">Photo & Video</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-pink-600 dark:text-pink-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.twitterUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-sky-50 to-cyan-100 dark:from-sky-950 dark:to-cyan-900 hover:from-sky-100 hover:to-cyan-200 dark:hover:from-sky-900 dark:hover:to-cyan-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-sky-200 dark:border-sky-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-sky-500 to-cyan-500 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">𝕏</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-sky-800 dark:text-sky-200 font-semibold text-sm block truncate">Twitter / X</span>
                          <span className="text-sky-600 dark:text-sky-400 text-xs opacity-75">Microblogging</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-sky-600 dark:text-sky-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.githubUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-gray-50 to-slate-100 dark:from-gray-950 dark:to-slate-900 hover:from-gray-100 hover:to-slate-200 dark:hover:from-gray-900 dark:hover:to-slate-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-gray-200 dark:border-gray-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-gray-800 to-black rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">🐙</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-gray-800 dark:text-gray-200 font-semibold text-sm block truncate">GitHub</span>
                          <span className="text-gray-600 dark:text-gray-400 text-xs opacity-75">Code Repository</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-gray-600 dark:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.youtubeUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-red-50 to-rose-100 dark:from-red-950 dark:to-rose-900 hover:from-red-100 hover:to-rose-200 dark:hover:from-red-900 dark:hover:to-rose-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-red-200 dark:border-red-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-rose-600 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">▶️</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-red-800 dark:text-red-200 font-semibold text-sm block truncate">YouTube</span>
                          <span className="text-red-600 dark:text-red-400 text-xs opacity-75">Video Content</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-red-600 dark:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.tiktokUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-gray-50 to-zinc-100 dark:from-gray-950 dark:to-zinc-900 hover:from-gray-100 hover:to-zinc-200 dark:hover:from-gray-900 dark:hover:to-zinc-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-gray-200 dark:border-gray-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-black to-gray-800 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">🎵</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-gray-800 dark:text-gray-200 font-semibold text-sm block truncate">TikTok</span>
                          <span className="text-gray-600 dark:text-gray-400 text-xs opacity-75">Short Videos</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-gray-600 dark:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.behanceUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-blue-950 dark:to-indigo-900 hover:from-blue-100 hover:to-indigo-200 dark:hover:from-blue-900 dark:hover:to-indigo-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-blue-200 dark:border-blue-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center text-white font-bold shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-xs">Be</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-blue-800 dark:text-blue-200 font-semibold text-sm block truncate">Behance</span>
                          <span className="text-blue-600 dark:text-blue-400 text-xs opacity-75">Creative Portfolio</span>
                        </div>
                    ...
                    {user.dribbbleUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-pink-50 to-rose-100 dark:from-pink-950 dark:to-rose-900 hover:from-pink-100 hover:to-rose-200 dark:hover:from-pink-900 dark:hover:to-rose-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-pink-200 dark:border-pink-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">🏀</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-pink-800 dark:text-pink-200 font-semibold text-sm block truncate">Dribbble</span>
                          <span className="text-pink-600 dark:text-pink-400 text-xs opacity-75">Design Showcase</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-pink-600 dark:text-pink-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                    ...
                    {user.otherSocialUrl && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-slate-50 to-gray-100 dark:from-slate-950 dark:to-gray-900 hover:from-slate-100 hover:to-gray-200 dark:hover:from-slate-900 dark:hover:to-gray-800 transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-slate-200 dark:border-slate-800"
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-slate-500 to-gray-600 rounded-xl flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300">
                          <span className="text-lg">🔗</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <span className="text-slate-800 dark:text-slate-200 font-semibold text-sm block truncate">Other Platform</span>
                          <span className="text-slate-600 dark:text-slate-400 text-xs opacity-75">Custom Link</span>
                        </div>
                        <ExternalLink className="w-4 h-4 text-slate-600 dark:text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </a>
                    )}
                  </div>
                </CardContent>
