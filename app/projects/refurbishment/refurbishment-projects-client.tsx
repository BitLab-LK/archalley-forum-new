...
interface RefurbishmentProjectsClientProps {
  initialProjects?: WordPressPost[]
  initialCategories?: WordPressCategory[]
}

export default function RefurbishmentProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: RefurbishmentProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Refurbishment Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our refurbishment portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our refurbishment and renovation projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getRefurbishmentProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Refurbishment", slug: "refurbishment", description: "Refurbishment projects", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Explore our portfolio of refurbishment and renovation projects that transform 
            existing structures, preserving heritage while embracing modern functionality.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Refurbishment projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-refurbishment"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Refurbishment Project</span>
                </div>
                <div className="flex items-center gap-2">
