...
interface ResidentialProjectsClientProps {
  initialProjects?: WordPressPost[]
  initialCategories?: WordPressCategory[]
}

export default function ResidentialProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: ResidentialProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Residential Architecture Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our residential architecture portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our residential architecture and housing projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getResidentialProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Residential Architecture", slug: "residential", description: "Residential architecture projects", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Explore our portfolio of residential projects including modern homes, luxury villas, 
            apartments, and innovative housing solutions designed for contemporary living.
          </p>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-residential"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
