...
interface LandscapeProjectsClientProps {
  initialProjects?: WordPressPost[]
  initialCategories?: WordPressCategory[]
}

export default function LandscapeProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: LandscapeProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Landscape Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our landscape and urbanism portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our landscape architecture and urban planning projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getLandscapeProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Landscape", slug: "landscape", description: "Landscape projects", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Explore our portfolio of landscape architecture and urban planning projects 
            that create sustainable, vibrant, and people-centered public spaces.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Landscape projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-landscape"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
