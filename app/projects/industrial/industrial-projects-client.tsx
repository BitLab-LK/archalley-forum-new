...
interface IndustrialProjectsClientProps {
  initialProjects?: WordPressPost[]
  initialCategories?: WordPressCategory[]
}

export default function IndustrialProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: IndustrialProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Industrial Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our industrial and infrastructure projects portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our industrial and infrastructure projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getIndustrialProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Industrial", slug: "industrial", description: "Industrial buildings", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover our portfolio of industrial buildings and infrastructure projects 
            designed for maximum functionality, efficiency, and operational excellence.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Industrial projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-industrial"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
