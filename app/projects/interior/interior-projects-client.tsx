...
interface InteriorProjectsClientProps {
  initialProjects?: WordPressPost[]
  initialCategories?: WordPressCategory[]
}

export default function InteriorProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: InteriorProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Interior Design Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our interior design portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our interior design projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getInteriorProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Interior Design", slug: "interior", description: "Interior design projects", count: 1 }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Discover our portfolio of stunning interior design projects that seamlessly 
            blend aesthetics with functionality, creating spaces that inspire and delight.
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Interior design projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm p-1">
                <AdBannerComponent 
                  size="320x320" 
                  className="w-full" 
                  positionId="sidebar-square-interior"
                  autoRotate={true}
                  rotationInterval={30}
                  showLabel={false}
                />
