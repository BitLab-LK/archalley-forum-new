...
export default function CommercialProjectsClient({ 
  initialProjects = [], 
  initialCategories = [] 
}: CommercialProjectsClientProps) {
  ...
  const fallbackProjects = initialProjects.length === 0 ? [
    {
      id: 1,
      title: { rendered: "Commercial Projects Coming Soon" },
      excerpt: { rendered: "We're currently updating our commercial projects portfolio. Please check back soon for our latest work." },
      content: { rendered: "Our commercial and office projects showcase will be available soon with detailed case studies and project galleries." },
      featured_media: 1,
  ...
  const loadMoreProjects = async () => {
    ...
    try {
      ...
      const newProjects = await getCommercialProjects(newPage, 20)
  ...
  const displayCategories = categories.length > 0 ? categories : [
    { id: 1, name: "Commercial", slug: "commercial", description: "Commercial buildings", count: 1 }
  ]
          ...
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchTerm 
                ...
                : 'Commercial projects will be displayed here once they are available.'
              }
            </p>
          </div>
        )}
