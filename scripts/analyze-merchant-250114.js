...
async function analyzePaymentsByMerchant250114() {
  try {
    ...
    console.log('💳 MERCHANT ID: 250114 - USER DETAILS');
    console.log('='.repeat(80));
    ...
    uniqueUsers.forEach(email => {
      ...
      console.log(`  - ${userName} (${email}): ${userPayments.length} payments, ${userTotal.toLocaleString()} LKR`);
    });
...
analyzePaymentsByMerchant250114();
